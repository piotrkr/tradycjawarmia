var menuBtn=document.querySelector(".hamburger__menu"),offScreen=document.querySelector(".off__screen"),offScreenMenu=document.querySelector(".off__screen__menu");function closeAllSubmenus(){document.querySelectorAll(".off__screen__add.active").forEach(function(e){e.classList.remove("active")}),document.querySelectorAll(".off__screen__toggle span").forEach(function(e){e.textContent="+"})}menuBtn.addEventListener("click",function(){menuBtn.classList.toggle("active"),offScreen.classList.toggle("active"),closeAllSubmenus()}),document.querySelectorAll('.off__screen__toggle > a[href="#"]').forEach(function(e){e.addEventListener("click",function(e){e.preventDefault(),e.stopPropagation();var e=this.closest("li").querySelector(".off__screen__add"),t=e.classList.contains("active");closeAllSubmenus(),!t&&(e.classList.add("active"),t=this.querySelector("span"))&&(t.textContent="–")})}),document.querySelectorAll('.off__screen__menu a[href]:not([href="#"])').forEach(function(e){e.addEventListener("click",function(e){var t,n,a=this.getAttribute("href").trim();menuBtn.classList.remove("active"),offScreen.classList.remove("active"),closeAllSubmenus(),a.startsWith("#")&&1<a.length?(t=document.querySelector(a))&&(e.preventDefault(),setTimeout(function(){t.scrollIntoView({behavior:"smooth"})},350)):a.includes("#")&&(a=a.split("#")[1],n=document.querySelector("#"+a))&&(e.preventDefault(),window.location.href="/",setTimeout(function(){n.scrollIntoView({behavior:"smooth"})},500))})}),window.addEventListener("pageshow",function(e){e.persisted&&(menuBtn.classList.remove("active"),offScreen.classList.remove("active"),closeAllSubmenus())}),"/"===location.pathname||location.pathname.includes("index.html")||(menuBtn.classList.remove("active"),offScreen.classList.remove("active"),closeAllSubmenus());var galleryItems=document.querySelectorAll(".gallery-item"),lightbox=document.createElement("div"),lightboxContent=(lightbox.className="lightbox",document.createElement("div")),lightboxImg=(lightboxContent.className="lightbox-content",document.createElement("img")),lightboxPrevBtn=(lightboxImg.id="lightbox-img",document.createElement("div")),lightboxNextBtn=(lightboxPrevBtn.className="lightbox-prev",lightboxPrevBtn.innerHTML='<i class="fa fa-angle-left"></i>',document.createElement("div")),closeArea=(lightboxNextBtn.className="lightbox-next",lightboxNextBtn.innerHTML='<i class="fa fa-angle-right"></i>',document.createElement("div")),currentIndex=(closeArea.className="lightbox-close-area",lightbox.appendChild(closeArea),lightbox.appendChild(lightboxContent),lightboxContent.appendChild(lightboxImg),lightbox.appendChild(lightboxPrevBtn),lightbox.appendChild(lightboxNextBtn),document.body.appendChild(lightbox),0);function openLightbox(e){e=galleryItems[currentIndex=e].dataset.full;lightboxImg.src=e,lightbox.style.display="flex"}function closeLightbox(){lightbox.style.display="none"}galleryItems.forEach(function(e,t){e.addEventListener("click",function(){return openLightbox(t)})}),lightboxPrevBtn.addEventListener("click",function(e){e.stopPropagation(),openLightbox(currentIndex=(currentIndex-1+galleryItems.length)%galleryItems.length)}),lightboxNextBtn.addEventListener("click",function(e){e.stopPropagation(),openLightbox(currentIndex=(currentIndex+1)%galleryItems.length)}),closeArea.addEventListener("click",closeLightbox),lightbox.addEventListener("click",function(e){e.target===lightbox&&closeLightbox()}),document.addEventListener("keydown",function(e){"flex"===lightbox.style.display&&("ArrowLeft"===e.key&&lightboxPrevBtn.click(),"ArrowRight"===e.key&&lightboxNextBtn.click(),"Escape"===e.key)&&closeLightbox()});var showPage,renderPagination,totalPages,currentPage,displayedLastPageNumber,prevBtn,nextBtn,scrollAmount,announcementPages=document.querySelectorAll(".announcements-page"),pageNumbersContainer=document.getElementById("page-numbers"),paginationPrevBtn=document.getElementById("prev-btn"),paginationNextBtn=document.getElementById("next-btn"),announcementsSection=document.querySelector("#announcements"),newsData=(0<announcementPages.length&&pageNumbersContainer&&paginationPrevBtn&&paginationNextBtn&&(showPage=function(n){announcementPages.forEach(function(e,t){e.hidden=t+1!==n}),currentPage=n,document.querySelectorAll(".page-number").forEach(function(e){var t=parseInt(e.dataset.page);e.classList.toggle("active",t===n)}),paginationPrevBtn.classList.toggle("disabled",1===currentPage),paginationNextBtn.classList.toggle("disabled",currentPage===totalPages),announcementsSection&&announcementsSection.scrollIntoView({behavior:"smooth",block:"start"})},renderPagination=function(){pageNumbersContainer.innerHTML="";for(var e=function(e){var t=document.createElement("button");t.className="page-number",t.dataset.page=e,t.textContent=e,t.addEventListener("click",function(){return showPage(e)}),e===currentPage&&t.classList.add("active"),pageNumbersContainer.appendChild(t)},t=1;t<=Math.min(3,totalPages);t++)e(t);4<totalPages&&((n=document.createElement("span")).className="page-number dots",n.textContent="...",pageNumbersContainer.appendChild(n));var n=Math.max(totalPages,displayedLastPageNumber);3<totalPages&&3<n&&e(totalPages)},totalPages=announcementPages.length,currentPage=1,displayedLastPageNumber=10,paginationPrevBtn.addEventListener("click",function(){1<currentPage&&showPage(currentPage-1)}),paginationNextBtn.addEventListener("click",function(){currentPage<totalPages&&showPage(currentPage+1)}),renderPagination(),showPage(1)),[{image:"../img/592960151_1154488490130242_8877612135666923510_n.jpg",date:"15 grudnia 2025",title:"Msza święta w Sanktuarium Gietrzwałdzkim",excerpt:"W gietrzwałdzkim sanktuarium odbyła się msza tradycyjna z udziałem naszego duszpasterstwa.",link:"msza-swieta-w-sanktuarium-gietrzwaldzkim.html"},{image:"../img/księża.jpg",title:"Profesje wieczyste",date:"8 grudnia 2025",excerpt:"Księża z naszej wspólnoty złożyli profesje wieczyste podczas uroczystej Mszy św.",link:"#artykul2"},{image:"../img/dzwon.jpg",title:"Uroczyste poświęcenie dzwonu",date:"1 listopada 2025",excerpt:"Nowy dzwon dla naszej kaplicy został poświęcony przez księdza biskupa.",link:"#artykul3"},{image:"https://www.osmol.pl/wp-content/uploads/2021/03/Swieta-Lipka.webp",title:"Pielgrzymka do Świętej Lipki",date:"20 października 2025",excerpt:"Coroczna pielgrzymka duszpasterstwa do sanktuarium w Świętej Lipce.",link:"#artykul4"},{image:"https://nikidw.edu.pl/wp-content/uploads/2024/12/advent-1883840_1280.jpg",title:"Rekolekcje adwentowe",date:"5 grudnia 2025",excerpt:"Rozpoczęły się rekolekcje adwentowe prowadzone przez ks. proboszcza.",link:"#artykul5"},{image:"https://codziennypoznan.pl/wp-content/uploads/2025/12/Oplatek-Wigilia.png",title:"Spotkanie opłatkowe",date:"20 grudnia 2025",excerpt:"Tradycyjne spotkanie opłatkowe wspólnoty przed Bożym Narodzeniem.",link:"#artykul6"},{image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqU0azU1ut0lJKIy-C0UJTl7DdWTZWqb4ZMg&s",title:"Msza św. Requiem",date:"10 listopada 2025",excerpt:"Rozpoczęcie cyklu Mszy św. gregoriańskich za zmarłych.",link:"#artykul7"},{image:"https://diecezja.pl/wp-content/uploads/2023/09/katecheza2.jpg",title:"Katecheza dla młodzieży",date:"25 października 2025",excerpt:"Spotkanie formacyjne dla młodzieży z duszpasterstwa.",link:"#artykul8"},{image:"https://kurierostrowski.pl/wp-content/uploads/2019/12/roraty-fot2.jpg",title:"Roraty 2025",date:"1 grudnia 2025",excerpt:"Zapraszamy na codzienne Msze roratnie w okresie Adwentu.",link:"#artykul9"}]),newsGrid=document.getElementById("newsGrid");function createNewsCard(e){var t=document.createElement("article");return t.className="news-card",t.innerHTML='\n    <img src="'.concat(e.image,'" alt="').concat(e.title,'" class="news-card__image">\n    <div class="news-card__content">\n      <span class="date">').concat(e.date,"</span>\n      <h3>").concat(e.title,"</h3>\n      <p>").concat(e.excerpt,'</p>\n      <a href="').concat(e.link,'" target="_blank" rel="noopener noreferrer">Czytaj dalej →</a>\n    </div>\n  '),t}newsGrid&&(newsData.forEach(function(e){newsGrid.appendChild(createNewsCard(e))}),prevBtn=document.querySelector(".news-carousel__prev"),nextBtn=document.querySelector(".news-carousel__next"),scrollAmount=370,nextBtn.addEventListener("click",function(){newsGrid.scrollBy({left:scrollAmount,behavior:"smooth"})}),prevBtn.addEventListener("click",function(){newsGrid.scrollBy({left:-scrollAmount,behavior:"smooth"})}),newsGrid.addEventListener("scroll",function(){prevBtn.classList.toggle("disabled",newsGrid.scrollLeft<=10),nextBtn.classList.toggle("disabled",newsGrid.scrollLeft+newsGrid.clientWidth>=newsGrid.scrollWidth-10)})),document.addEventListener("DOMContentLoaded",function(){var e=document.getElementById("current-year"),t=(e&&(e.textContent=(new Date).getFullYear()),document.getElementById("scrollTopBtn")),e=(t&&(window.addEventListener("scroll",function(){300<window.scrollY?t.classList.add("visible"):t.classList.remove("visible")}),t.addEventListener("click",function(){window.scrollTo({top:0,behavior:"smooth"})})),document.querySelectorAll(".accordion__header"));0===e.length?console.warn("Nie znaleziono elementów .accordion__header – sprawdź HTML"):e.forEach(function(e){e.addEventListener("click",function(){var e=this.nextElementSibling;e&&e.classList.contains("accordion__panel")&&(this.querySelector(".accordion__icon"),e.classList.contains("open")?(e.classList.remove("open"),this.classList.remove("active")):(e.classList.add("open"),this.classList.add("active")))})})}),document.addEventListener("DOMContentLoaded",function(){var e=document.querySelectorAll(".gallery-item");0!==e.length&&e.forEach(function(e){e.style.transition="opacity 0.3s ease",e.addEventListener("mouseenter",function(){e.style.opacity="1"}),e.addEventListener("mouseleave",function(){e.style.opacity="0.85"}),e.addEventListener("focus",function(){e.style.opacity="1"}),e.addEventListener("blur",function(){e.style.opacity="0.85"}),e.addEventListener("touchstart",function(){e.style.opacity="1"},{passive:!0}),e.addEventListener("touchend",function(){setTimeout(function(){e.style.opacity="0.85"},200)}),e.addEventListener("touchcancel",function(){e.style.opacity="0.85"})})}),document.addEventListener("DOMContentLoaded",function(){var t,n,a,o=document.getElementById("gallery-container");o&&(t=!1,o.addEventListener("mousedown",function(e){t=!0,o.classList.add("active"),n=e.pageX-o.offsetLeft,a=o.scrollLeft}),o.addEventListener("mouseleave",function(){t=!1,o.classList.remove("active")}),o.addEventListener("mouseup",function(){t=!1,o.classList.remove("active")}),o.addEventListener("mousemove",function(e){t&&(e.preventDefault(),e=2*(e.pageX-o.offsetLeft-n),o.scrollLeft=a-e)}))});
